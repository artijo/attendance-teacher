                            ...
                            <div className="space-y-3">
                                ...
                                <div className="flex items-center">
                                    ...
                                    <p className="text-lg">
                                        ...
                                        <span className="ml-2 text-text-color">{formatDate(activity.actDate)}</span>
                                    </p>
                                </div>
                            </div>
                            <div className="space-y-3">
                        ...
                        <div className="border-b border-line p-6">
                            ...
                            {!isValidDate && (
                                <div className="bg-yellow-50 border-l-4 border-yellow-400 text-yellow-800 p-4 mb-6 rounded-md flex items-start">
                                    ...
                                    <div>
                                        <p className="font-medium">สามารถบันทึกการเข้าร่วมได้เฉพาะในวันที่จัดกิจกรรมเท่านั้น</p>
                                        <p className="mt-1 text-sm">กิจกรรมนี้จะเริ่มในวันที่ {formatDate(activity.actDate)} ถึงวันที่ {formatDate(activity.actDateEnd)}</p>
                                    </div>
                                </div>
                            )}
