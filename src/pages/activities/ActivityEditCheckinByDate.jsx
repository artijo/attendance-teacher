...
function EditCheckIn() {
  ...
  const checkValidDate = (activity) => {
    ...
    return (
      checkDate >= startDate.startOf("day") && checkDate <= endDate.endOf("day")
    );
  };
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 font-body">
              ...
              <div className="bg-gray-50 p-4 rounded-lg">
                ...
                <input
                  ...
                  min={DateTime.fromISO(activity.actDate)
                    .setZone(TIME_ZONE)
                    .toISODate()}
                  max={DateTime.fromISO(activity.actDateEnd)
                    .setZone(TIME_ZONE)
                    .toISODate()}
                />
                ...
                <div className="bg-yellow-50 border-l-4 border-yellow-400 text-yellow-800 p-4 mb-6 rounded-md flex items-start">
                  ...
                  <div>
                    ...
                    <p className="mt-1 text-sm">
                      กรุณาเลือกวันที่อยู่ในช่วงวันที่จัดกิจกรรม (
                      {formatDate(activity.actDate)} -{" "}
                      {formatDate(activity.actDateEnd)})
                    </p>
                  </div>
                        ...
                        <td className="px-6 py-4 whitespace-nowrap">
                          <div className="flex justify-center gap-4">
                            ...
                            >
                              ...
                              <span
                                className={`peer-checked:text-green-600 font-medium ${
                                  dateParticipation !== undefined
                                    ? "text-green-600"
                                    : "text-gray-600"
                                }`}
                              >
                            ...
                            >
                              ...
                              <span
                                className={`peer-checked:text-red-600 font-medium ${
                                  dateParticipation === undefined
                                    ? "text-red-600"
                                    : "text-gray-600"
                                }`}
