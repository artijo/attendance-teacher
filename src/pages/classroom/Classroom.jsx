...
function Classroom() {
    ...
    return (
        <div className="min-h-screen">
            <div className="mb-6">
                <h1 className="text-2xl md:text-3xl font-bold text-primary font-heading">ห้องเรียนที่ปรึกษา</h1>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                    {classroooms.map((item, index) => (
                        <div
                            ...
                            className="relative overflow-hidden bg-white border border-line rounded-xl shadow-md hover:shadow-lg transition-all duration-300"
                        >
                            {/* ส่วนหัวการ์ด */}
                            ...
                            <div className="p-6">
                                <div className="flex justify-between items-start mb-4">
                                    <div>
                                        <span className="inline-block bg-primary/10 text-primary rounded-full px-3 py-1 text-sm font-semibold font-body">
                                            ม.{item.classLevel}/{item.classRoom}
                                        </span>
                                    </div>
                                    <span className="bg-secondary/10 text-secondary rounded-full px-3 py-1 text-sm font-semibold font-body">
                                        {item.term.semester}/{item.term.academicYear + 543}
                                    </span>
                                </div>
                                
                                <h3 className="font-heading font-bold text-lg text-text-color mb-2">
                                    ห้อง ม.{item.classLevel}/{item.classRoom}
                                </h3>
                                
                                <div className="space-y-2 font-body text-text-color-alt mb-4">
                                ...
                                >
                                    <button className="w-full py-2.5 px-4 text-sm font-medium text-white bg-primary hover:bg-accent rounded-lg focus:outline-none focus:ring-2 focus:ring-primary/30 transition-all duration-300 flex items-center justify-center">
                                        <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
